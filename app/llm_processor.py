#!/usr/bin/env python3
# llm_processor.py
# Procesa lotes de notas_x_usuario pendientes y guarda resultados Gemma
...
# ▶ Modelo
MODEL_ID = os.getenv("GEMMA3_MODEL", "google/gemma-3-1b-it")


def load_model():
    tok = AutoTokenizer.from_pretrained(MODEL_ID)
    mdl = Gemma3ForCausalLM.from_pretrained(MODEL_ID, torch_dtype=torch.float32).eval()
    return tok, mdl
...
# ▶ CLI
def main():
    parser = argparse.ArgumentParser(description="Process batches of notes with Gemma3")
